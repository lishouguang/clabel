...
from clabel.model.aux2 import Tokenizer
from clabel.model.aux2 import CharacterTable
...
class SBDModel(object):
    ...
    def __init__(self, raw_file, max_sentence_length=100, hidden_size=128, batch_size=128, layers=3):
        ...
        self._keras_model_file = os.path.join(self._workspace, 'sbd.keras.model')
