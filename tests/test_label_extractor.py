...
class MyTestCase(unittest.TestCase):
    ...
    def test_read_extract_file1(self):
        ...
        utils.write_file('D:\\meizu\\京东&天猫评论数据挖掘_全品类\\汇报_20170214\\label.txt', xx)
    ...
    def test_count_extract_file1(self):
        ...
        utils.write_file('D:\\meizu\\京东&天猫评论数据挖掘_全品类\\汇报_20170214\\label.counter', counter)
    ...
    def test_f1(self):
        ...
        for line in utils.iter_file('D:\\meizu\\京东&天猫评论数据挖掘_全品类\\汇报_20170214\\label.txt'):
            if line.startswith('pinglun:'):
                pinglun_count += 1

                xx = re.findall(r'\[(.*)\]', line)[0]
